...
export const HeaderArea = tw.div<any>`z-10 fixed flex w-full top-0 h-16 place-items-center justify-center col-span-3 backdrop-blur-sm  bg-current/30  shadow-lg dark:text-white`;
